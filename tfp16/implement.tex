...
To see a full definition of the language, see Appendix~\ref{chap:cem_appendix}.
...
lambda binding and application, and we treat it as such. This approach helps
ensure that we can compile arbitrary lambda terms without pre-processing, while
