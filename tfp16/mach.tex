...
machine and how it works, please refer to Figure~\ref{fig:state}, which displays
the steps in the evaluation of the term $(\lambda a.(\lambda b.b \; a) \lambda
c.c \; a) \; ((\lambda i.i) \lambda j.j)$, or
$(\lambda(\lambda0\;1)\;\lambda0\;1)\;((\lambda0)\; \lambda0)$ with de Bruijn
indices.
